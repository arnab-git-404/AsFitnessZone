        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              description: 'Custom workout plans tailored to your specific goals',
            },
            {
              icon: Clock,
              title: '24/7 Access',
              description: 'Work out on your schedule with round-the-clock availability',
            },
            {
              icon: Heart,
              title: 'Supportive Community',
              description: 'Join a motivating environment of like-minded individuals',
            },
            {
              icon: Trophy,
            ...
            <Card
              key={index}
              className="!border-border/50 hover:!border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10 group"
            >
